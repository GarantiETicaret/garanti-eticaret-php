...
<h2>Sipariş Detay Sorgulama</h2>
<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Orderhistoryinq<br>
...
<?php
    ...
    $request = new OrderHistoryInqRequest();
    ...
    $request->Transaction->Type="orderhistoryinq";
    $request->CurrencyCode="949";
  
    $request->Hash=Helper::ComputeHash($request,$settings);

    $response = OrderHistoryInqRequest::execute($request,$settings); //OrderHistoryInqRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
