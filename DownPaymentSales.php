...
<form action="" method="post" class="form-horizontal">
    <fieldset>
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  Peşinat Oranı:</label>
            <div class="col-md-4">
...
<?php
    ...
    $request = new DownPaymentSalesRequest();
    ...
    $request->DownPaymentRate =$_POST["downPaymentRate"];

    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = DownPaymentSalesRequest::execute($request,$settings); //DownPaymentSalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
