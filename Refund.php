...
<fieldset>
    ...
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Refund<br>
...
<form action="" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <button type="submit" id="" name="" class="btn btn-danger"> İade Et</button>
        </div>
    </div>
</form>
<?php if (!empty($_POST)): ?>
<?php
    ...
    $response = RefundRequest::execute($request,$settings); //RefundRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
