...
<?php
    ...
    $request = new FirmRewardSalesRequest();
    ...
    $response = FirmRewardSalesRequest::execute($request,$settings); //FirmRewardSalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
