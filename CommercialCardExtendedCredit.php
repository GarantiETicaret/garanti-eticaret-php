...
<h2>Ortak Kart İle Satış </h2>
<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Commercialcardextendedcredit<br>
            ...
            <div class="col-md-4">
                <table border="1">
                    <tr>
                        ...
                        <td><label class="col-md-4 control-label" for="">  Ödeme Zamanı </label></td>
...
<?php
    ...
    $request = new CommercialCardExtendedCreditRequest();
    ...
    $request->Transaction->Type="commercialcardextendedcredit";
    $request->CurrencyCode="949";
    $request->MotoInd="N";

    $request->InstallmentCnt="2";
    $request->Number="1";
    $request->DueDate="20181214";
    $request->Amount="1200";

    $request->Number1="2";
    $request->DueDate1="20190114";
    $request->Amount1="1200";
    
    
    $request->Hash=Helper::ComputeHash($request,$settings);

    $response = CommercialCardExtendedCreditRequest::execute($request,$settings); //CommercialCardExtendedCreditRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
