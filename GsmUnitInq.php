...
<fieldset>
    ...
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Gsmunitinq<br>
...
<form action="" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  Yüklenecek TL miktarı: </label>
            <div class="col-md-4">
...
<?php
    ...
    $request->Transaction->Amount="10000";
    $request->Transaction->Type="gsmunitinq";
    ...
    $response = GsmUnitInqRequest::execute($request,$settings); //GsmUnitInqRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
