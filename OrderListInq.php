...
<h2>Tarih aralığı ile İşlem Sorgulama</h2>
<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> orderlistinq<br>
...
<?php
    ...
    $request = new OrderListInqRequest();
    ...
    $request->Transaction->Type="orderlistinq";
    ...
    $response = OrderListInqRequest::execute($request,$settings); //OrderListInqRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
