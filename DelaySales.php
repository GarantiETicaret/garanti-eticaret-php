...
<form action="" method="post" class="form-horizontal">
    <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  Ötelenecek Gün sayısı:</label>
            <div class="col-md-4">
...
<?php
    ...
    $request->MotoInd="N";
    $request->DelayDayCount=$_POST["delayDayCount"];
    
  
    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = DelaySalesRequest::execute($request,$settings); //DelaySalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
