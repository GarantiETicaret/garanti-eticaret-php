...
<h2>Garanti Pay ile Mail Order İşlem </h2>
<br />
<fieldset>
...
<?php
    ...
    $request = new GarantiPayMORequest();
	...
	$request->OrderInfo = "ürün hakkında bilgi içerir.";
	$request->TxnTimeOutPeriod = "300";
	$request->NotifSendInd = "Y";
    ...
    $response = GarantiPayMORequest::execute($request,$settings); //GarantiPayMORequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
