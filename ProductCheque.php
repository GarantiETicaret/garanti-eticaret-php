...
<h2>Sözünüze Ürün Çek Kullanım </h2>
<br />
<fieldset>
...
<?php
    ...
    $request = new ProductChequeRequest();
    ...
    $response = ProductChequeRequest::execute($request,$settings); //ProductChequeRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
