...
<fieldset>
    ...
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> utilitypaymentinq<br>
...
<?php
    ...
    $request = new UtilityPaymentInqRequest();
    ...
    $request->Transaction->Type="utilitypaymentinq";
    ...
    $response = UtilityPaymentInqRequest::execute($request,$settings); //UtilityPaymentInqRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
