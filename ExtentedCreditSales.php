...
<fieldset>
    ...
    <label style="font-weight:bold;">İşlem Tipi &nbsp; :   &nbsp; </label> extendedcredit<br>
...
<?php
    ...
    $request = new ExtentedCreditSalesRequest();
    ...
    $request->secure3dhash=ExtentedCreditSalesRequest::Compute3DHash($request,$settings3D);
    $response = ExtentedCreditSalesRequest::execute($request,$settings3D); //ExtentedCreditSalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print $response;
	?>
