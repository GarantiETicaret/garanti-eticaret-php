...
<h2>Ekstre Doğrulama/Ön Otorizasyon Kapama</h2>
<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> postauth<br>
	    <label style="font-weight:bold;">İşlem Adı &nbsp; :   &nbsp; </label> extre<br>
...
<?php
    ...
    $request = new ExtrePostauthRequest();
    ...
    $request->Transaction->Type="postauth";
    $request->CurrencyCode="949";
    $request->MotoInd="H";
    $request->SubType="extre";
    $request->ExtreInfo = $_POST["extreInfo"];
    
    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = ExtrePostauthRequest::execute($request,$settings); //ExtrePostauthRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
