...
<h2>Firma Kartı ile Satış </h2>
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> firmcardsales<br>
...
<?php
    ...
    $request = new FirmCardSalesRequest();
    ...
    $request->Card->Number=$_POST["firmCreditCardNo"];
    ...
    $request->Transaction->Type="firmcardsales";
    $request->CurrencyCode="949";
    $request->MotoInd="N";

    
    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = FirmCardSalesRequest::execute($request,$settings); //FirmCardSalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
