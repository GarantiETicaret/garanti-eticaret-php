...
<form action="" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input value="1" name="transactionAmount" class="form-control input-md">
            </div>
        </div>
    </fieldset>
    <!-- Button -->
...
<?php
    ...
    $response = SalesRequest::execute($request,$settings); //SalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    
//Validation	
$sxml = new SimpleXMLElement($response);
$reasonCode=$sxml->Transaction[0]->Response->ReasonCode;
$retRefNum=$sxml->Transaction[0]->RetrefNum;
$authCode=$sxml->Transaction[0]->AuthCode;
$provDate=$sxml->Transaction[0]->ProvDate;
$orderId=$sxml->Order[0]->OrderID;
$terminalId=$sxml->Terminal[0]->ID;
$hashData=$sxml->Transaction[0]->HashData;

$hashString = $reasonCode . $retRefNum . $authCode . $provDate . $orderId;
$validhash = Helper::ComputeHashForXmlValidation($hashString, $terminalId, $settings);
