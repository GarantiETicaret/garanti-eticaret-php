...
<h2>SMS Doğrulama/Ön Otorizasyon Kapama</h2>
<br />
<fieldset>
...
<form action="" method="post" class="form-horizontal">
    <fieldset>
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  SMS Şifresi:</label>
            <div class="col-md-4">
...
<?php
    ...
    $request = new SMSPostauthRequest();
    ...
    $request->MotoInd="N";
    $request->SubType="sms";
    $request->SMSPassword=$_POST["smsPassword"];
    

    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = SMSPostauthRequest::execute($request,$settings); //SMSPostauthRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
