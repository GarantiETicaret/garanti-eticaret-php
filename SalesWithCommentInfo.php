...
<h2>Özel Alan Bilgileri ile Satınalma işlemi </h2>
<br />
<fieldset>
...
<form action="" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  Bilgi Numarası:</label>
            <div class="col-md-4">
...
<?php
    ...
    $request = new SalesWithCommentInfoRequest();
    ...
    $response = SalesWithCommentInfoRequest::execute($request,$settings); //SalesWithCommentInfoRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
