<?php
//Sipariş Detayı Sorgulama Çağrısının yapıldığı sınıfı temsil etmektedir.
class OrderHistoryInqRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $Hash;

    public static function Execute(OrderHistoryInqRequest $request,Settings $settings)
    {
