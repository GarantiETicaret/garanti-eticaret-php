...
//Tarihe ve Kredi Kartı numarasına Göre Sipariş Sorgulama Çağrısının yapıldığı sınıfı temsil etmektedir.
class CardtxnListInqRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $Hash;
    

    public static function Execute(CardtxnListInqRequest $request,Settings $settings)
    {
