...
class Sale3DPayRequest extends VPOSRequest
{
    public $mode;
    public $apiversion;
    ...
    public static function Execute(Sale3DPayRequest $request,Settings3D $settings3D)
    {
	...
	public static function Compute3DHash(Sale3DPayRequest $request,Settings3D $settings3D)
    {
