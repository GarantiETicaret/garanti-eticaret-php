...
//Sipariş Sorgulama Çağrısının yapıldığı sınıfı temsil etmektedir.
class OrderItemInqRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $Hash;
    

    public static function Execute(OrderItemInqRequest $request,Settings $settings)
    {
