...
//peşinatlı-taksitli satış istek sınıfını temsil etmektedir.
class DownPaymentSalesRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    public $DownPaymentRate;
    public $InstallmentCnt;

    public static function Execute(DownPaymentSalesRequest $request,Settings $settings)
    {
      ...
      public function toXmlString()
      {
          ...
          "         <DownPaymentRate>" .$this->DownPaymentRate . "</DownPaymentRate>\n" .
