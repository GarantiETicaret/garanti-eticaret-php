<?php
//Sözünüze Çek kullanımı istek çağrısının yapıldığı sınıfı temsil etmektedir.
class ProductChequeRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(ProductChequeRequest $request,Settings $settings)
    {
