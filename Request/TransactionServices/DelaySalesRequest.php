<?php
//Ötelemeli satış istek yapılan sınıfı temsil etmektedir.
class DelaySalesRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(DelaySalesRequest $request,Settings $settings)
    {
      ...
      public function toXmlString()
      {
          ...
          "         <DelayDayCount>" .$this->DelayDayCount . "</DelayDayCount>\n" .
