<?php
//Firma Kart ile satış istek çağrısının yapıldığı sınıfı temsil etmektedir.
class FirmCardSalesRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(FirmCardSalesRequest $request,Settings $settings)
    {
