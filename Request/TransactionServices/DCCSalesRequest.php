<?php
//Dcc  satış istek yapılan sınıfı temsil etmektedir.
class DCCSalesRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    public $SubType;
    public $OriginalRetrefNum;
    public $DCCCurrency;

    public static function Execute(DCCSalesRequest $request,Settings $settings)
    {
      ...
      public function toXmlString()
      {
          ...
          "         <OriginalRetrefNum>" .$this->OriginalRetrefNum . "</OriginalRetrefNum>\n" .
          "         <DCC>\n" .
          "             <Currency>" .$this->DCCCurrency . "</Currency>\n" .
          "         </DCC>\n" .
          "    </Transaction>\n" .
          "</GVPSRequest>";
           return $xml_data;
