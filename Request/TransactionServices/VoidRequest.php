<?php
//İptal (Void) servis istek servisinin yapıldığı sınıfı temsil etmektedir.
class VoidRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(VoidRequest $request,Settings $settings)
    {
