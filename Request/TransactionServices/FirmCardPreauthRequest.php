<?php
//Firma Card Ön Otorizasyon istek çağrısının yapıldığı sınıfı temsil etmektedir.
class FirmCardPreauthRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(FirmCardPreauthRequest $request,Settings $settings)
    {
