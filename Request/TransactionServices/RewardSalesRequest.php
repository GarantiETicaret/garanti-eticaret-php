<?php
//Bonus Kullanım istek çağrısının yapıldığı sınıfı temsil etmektedir.
class RewardSalesRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(RewardSalesRequest $request,Settings $settings)
    {
