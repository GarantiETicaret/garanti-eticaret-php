<?php
//Ekstre Doğrulama/Ön Otorizasyon ile satış işlemi Örnek sınıfı ve çağrısını temsil eder.
class ExtrePreauthRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(ExtrePreauthRequest $request,Settings $settings)
    {
