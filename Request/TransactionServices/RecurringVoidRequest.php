<?php
//Tekrarlı İptal istek çağrısının yapıldığı sınıfı temsil etmektedir.
class RecurringVoidRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;

    public static function Execute(RecurringVoidRequest $request,Settings $settings)
    {
