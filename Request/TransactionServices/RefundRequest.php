<?php
//İade (refund) istek çağrısının yapıldığı sınıfı temsil etmektedir.
class RefundRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;

    public static function Execute(RefundRequest $request,Settings $settings)
    {
