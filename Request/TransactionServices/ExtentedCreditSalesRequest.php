...
class ExtentedCreditSalesRequest extends VPOSRequest
{
    public $mode;
    public $apiversion;
    ...
    public static function Execute(ExtentedCreditSalesRequest $request,Settings3D $settings3D)
    {
	...
	public static function Compute3DHash(ExtentedCreditSalesRequest $request,Settings3D $settings3D)
    {
