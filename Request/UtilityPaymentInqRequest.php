...
//Fatura Sorgulama Çağrısının yapıldığı sınıfı temsil etmektedir.
class UtilityPaymentInqRequest extends VPOSRequest
{
    public $CurrencyCode;
    public $MotoInd;
    public $Hash;
    ...
    public static function Execute(UtilityPaymentInqRequest $request,Settings $settings)
    {
