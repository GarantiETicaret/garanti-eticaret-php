...
<form action="" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for="">  Fatura Numarası: </label>
            <div class="col-md-4">
...
<?php
    ...
    $request = new UtilityPaymentRequest();
    ...
    $request->Transaction->Type="utilitypayment";
    ...
    $response = UtilityPaymentRequest::execute($request,$settings); //UtilityPaymentRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
