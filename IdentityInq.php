...
<fieldset>
    ...
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> identifyinq<br>
...
<form action="" method="post" class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label" for=""> Tc Numarası:</label>
            <div class="col-md-4">
...
<?php
    ...
    $request = new IdentityInqRequest();
    ...
    $request->Transaction->Type="identifyinq";
    $request->CurrencyCode="949";
    $request->MotoInd="H";
    $request->CardholderPresentCode = "0";
    $request->Identity=$_POST["identity"];

    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = IdentityInqRequest::execute($request,$settings); //IdentityInqRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
