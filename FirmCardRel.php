...
<h2>Firma Kart Eşleştirme </h2>
<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Firmcardrel<br>
...
<form action="" method="post" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-4">
            <button type="submit" id="" name="" class="btn btn-danger"> Eşleştir</button>
        </div>
    </div>
</form>
...
<?php
    ...
    $request = new FirmCardRelRequest();
    ...
    $request->Transaction->Type="firmcardrel";
    $request->CurrencyCode="949";
    $request->MotoInd="H";
    $request->FirmCardNo=$_POST["firmCardNo"];

    
    $request->Hash=Helper::ComputeHash($request,$settings);
    $response = FirmCardRelRequest::execute($request,$settings); //FirmCardRelRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
