...
<h2>Ekstre Doğrulama/Ön Otorizasyon </h2>
<br />
<fieldset>
...
<?php
    ...
    $request = new ExtrePreauthRequest();
    ...
    $response = ExtrePreauthRequest::execute($request,$settings); //ExtrePreauthRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
