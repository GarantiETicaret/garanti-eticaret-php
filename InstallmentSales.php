...
<h2>Taksitli Satış</h2>

<br />
<fieldset>

    <legend><label style="font-weight:bold;width:250px;">Terminal Bilgileri</label></legend>
    <label style="font-weight:bold;">Servis Adı &nbsp; :   &nbsp; </label> Installment Sales<br>
...
<?php
    ...
    $request = new InstallmentSalesRequest();
    ...
    $response = InstallmentSalesRequest::execute($request,$settings); //InstallmentSalesRequest servisi başlatılması için gerekli servis çağırısını temsil eder.
    print "<h3>Sonuç:</h3>";
	echo "<pre>";
